from sqlalchemy import Integer, String, Float, ForeignKey, Boolean, UniqueConstraint
...
class AutomationRule(Base):
    ...
    __table_args__ = (
        UniqueConstraint("room_id", "name", name="uq_rule_room_name"),
    )
    ...
    alert_level: Mapped[str] = mapped_column(String(20), nullable=False, default="MEDIUM")
